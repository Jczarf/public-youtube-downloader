...
class YouTubeDownloaderWindow(QMainWindow):
    ...
    def _theme(self) -> None:
        ...
        self.setStyleSheet(
            ...
            QWidget#queueViewport, QWidget#queueBody, QWidget#historyViewport, QWidget#historyBody {{ background:{C['panel']}; }}
    ...
    def _build_queue_page(self) -> QWidget:
        ...
        sl.addWidget(save)
        sl.addStretch()
        legal = plain_label("Uso pessoal. Baixe somente conteúdo que você tem direito de acessar e respeite os termos da plataforma.")
